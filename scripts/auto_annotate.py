...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, required=True, help="Path to a folder containing images to be annotated.")
    parser.add_argument("--det_model", type=str, default="../models/best.pt", help="Path to the pre-trained YOLO detection model.")
    parser.add_argument("--output_dir", type=str, default=None, help="Directory to save the annotated results.")
    parser.add_argument("--device", type=str, default="", help="Device to run the models on (e.g., 'cpu', '0').")
    args = parser.parse_args()

    auto_annotate(data=args.data, det_model=args.det_model, output_dir=args.output_dir, device=args.device)
